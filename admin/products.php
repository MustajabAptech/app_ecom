                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ?>
                                     <tr>
                                        ...
                                        <td> <a href="editProduct.php?prod_id=<?php echo $row['prod_id'];?>" class="btn btn-sm btn-warning">Edit</a> | <a href="deleteProduct.php?prod_id=<?php echo $row['prod_id'];?>" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
                                    <?php
                                }
                            }else{
